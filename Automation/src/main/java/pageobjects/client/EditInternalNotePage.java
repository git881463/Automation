package pageobjects.client;
	 ...
	 */
	public class EditInternalNotePage extends AbstractBasePageObject<EditInternalNotePage> {

	    private static final Logger logger = LoggerFactory.getLogger(EditInternalNotePage.class);

	    private static final String relativeUrl = "/notes/edit";

	    public EditInternalNotePage(WebDriver driver, WebDriverWait wait, String url) {
