package pageobjects.invoice;
	...
	/**
	 * Class representing Billing Reminders Popup in CRC application.
	 * Methods Load() and isLoaded() has to be implemented in a way that it represent the actual behaviour in real application.
	 */
	public class BillingRemindersPopup extends AbstractBasePageObject<BillingRemindersPopup> {

	    private static final Logger logger = LoggerFactory.getLogger(BillingRemindersPopup.class);

	    private static final String relativeUrl = "/invoices";

	    public BillingRemindersPopup(WebDriver driver, WebDriverWait wait, String url) {
	    ...
	    protected void isLoaded() throws Error {
	        ...
	        Assert.assertTrue("Not on the Invoices page billing reminders popup: " + url, url.endsWith(relativeUrl));
	    ...
	    @FindBy(how = How.XPATH, using = "//div[@class='ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix']//span[contains(text(),'Reminder')]//following-sibling::a")
