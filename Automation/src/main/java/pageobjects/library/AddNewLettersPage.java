package pageobjects.library;
	 ...
	 */
	public class AddNewLettersPage extends AbstractBasePageObject<AddNewLettersPage> {

	    private static final Logger logger = LoggerFactory.getLogger(AddNewLettersPage.class);

	    private static final String relativeUrl = "/add";

	    public AddNewLettersPage(WebDriver driver, WebDriverWait wait, String url) {
	    ...
	    public void isLoaded() throws Error {
	        ...
	        Assert.assertTrue("Not on the library page add new letters page: " + url, url.endsWith(relativeUrl));
	        logger.warn(getClass().getSimpleName() + " was loaded successfully");
	    }

	    @FindBy(how = How.XPATH, using = "//div[contains(text(),'Add Letters')]")
	    ...
	    @FindBy(how = How.XPATH, using = "//form[@id='mylibrary']//input[@id='submit']")
